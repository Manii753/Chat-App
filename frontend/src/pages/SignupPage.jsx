...
import { MessageSquare,User,Lock,Mail,Eye,EyeClosed,Loader2 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 mt-4" >
      ...
      <div className='flex flex-col justify-center items-center p-6 sm:p-12 lg:p-16'>
        ...
        <form className='space-y-0 sm:w-auto lg:w-full md:w-auto' onSubmit={handleSubmit}>
